...
})({"e4NMr":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "bb851660517c9c17";
"use strict";
...
},{}],"fQXFr":[function(require,module,exports,__globalThis) {
// Remove: import Web3 from "web3";
// Remove: const Web3 = require("web3").default; // Don't need Web3 in the frontend anymore
async function fetchData() {
    try {
        ...
        if (data.message) {
            console.log(data.message); // e.g., "No readings available yet."
            // Optionally clear the display or show a message
        ...
        } else console.warn("Received unexpected data format:", data);
    } catch (error) {
...
},{}]},["e4NMr","fQXFr"], "fQXFr", "parcelRequire94c2", {})

//# sourceMappingURL=public.517c9c17.js.map
